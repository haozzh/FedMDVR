...
from models.distributed_training_utils_adabest import Client, Server
...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        for client in participating_clients:
            ...
            client.compute_weight_update(server, m=m, iter=iter+1)

        server.aggregate_weight_updates(clients=participating_clients, iter=iter+1)

        server.computer_weight_update_down_dw(clients=participating_clients, iter=iter+1)
