...
from models.distributed_training_utils_DP import Client, Server
...
if __name__ == '__main__':
    ...
    number_data = data_obj.clnt_x[0].shape[0]
    ...
    for iter in range(args.epochs):
        ...
        if args.dp_p == 1:
            server.add_download(iter=iter, m=m, number_data = number_data)
