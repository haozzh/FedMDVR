...
class client_model(nn.Module):
    def __init__(self, name, args=True):
        ...
        if self.name == 'shakes_LSTM':
            ...
            self.weight_keys = [['embedding.weight'],
                                ['stacked_LSTM.weight_ih_l0', 'stacked_LSTM.weight_hh_l0', 'stacked_LSTM.bias_ih_l0', 'stacked_LSTM.bias_hh_l0'],
                                ['stacked_LSTM.weight_ih_l1', 'stacked_LSTM.weight_hh_l1', 'stacked_LSTM.bias_ih_l1', 'stacked_LSTM.bias_hh_l1'],
                                ['fc.weight', 'fc.bias']]
