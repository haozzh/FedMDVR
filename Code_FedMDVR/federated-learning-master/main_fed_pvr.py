...
from models.Nets_pvr import client_model
from utils.dataset import DatasetObject, ShakespeareObjectCrop_noniid
from models.distributed_training_utils_fedpvr import Client, Server
...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        for client in participating_clients:
            ...
            client.compute_bias(server, w_glob_keys)
            client.compute_weight_update(server, m=m, iter=iter, w_glob_keys=w_glob_keys)
